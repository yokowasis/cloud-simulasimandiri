...
?>
      ...
      <div class='col-md-12'>
        ...
        <div id='loginfooter'>
          ...
          <div class="summary-log">
            <div class="content">
              <?php // echo ('<a href="#bimasoft.web.id" title="https://bimasoft.web.id/">Aplikasi Simulasi Mandiri</a> :<strong> #13.10.7</strong><br>') 
              ?>
            </div>
          </div>
        </div>
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/archives/js/login-lihat-nilai.js?bv=13.10.7"></script>
<?php
}
